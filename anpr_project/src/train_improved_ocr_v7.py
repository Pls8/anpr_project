"""
OCR Training v7 - Continue from augmented model
EfficientNet-B0 with continuation from v5_augmented
"""
...
MODEL_SAVE_PATH = os.path.join(TEST3OC_DIR, "best_improved_ocr_v7.pth")
PRETRAINED_PATH = os.path.join(TEST3OC_DIR, "best_improved_ocr_v5_augmented.pth")

print(f"=== OCR Training v7 - Continue from Augmented ===")
print(f"Pretrained: {PRETRAINED_PATH}")
print(f"Image size: 224x224 (B0)")
...
def main():
    ...
    optimizer = optim.AdamW(model.parameters(), lr=0.001, weight_decay=0.0001)  # Higher LR
